...
public class PrincipalUI extends JFrame {
	...
	public PrincipalUI() {
		...
		JMenuItem jmiVeiculos = new JMenuItem("Veiculos");
		...
		JMenuItem jmiConsultaVeiculos = new JMenuItem("Veiculos");
		...
		jmiConsultarChamado.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ConsultaChamadoUI consultaChamadoUI = new ConsultaChamadoUI();
